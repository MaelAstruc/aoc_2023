...
fn main() {
    ...
    part_2("
...
fn parse_input(input: &str) -> (Vec<Instruction>, Vec<String>, Graph) {
    ...
    for line in input_lines {
        ...
        let tuple_split = clean.split_once(", ")
            .unwrap();
